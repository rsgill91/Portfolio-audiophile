...
import "./Navbar.css";
import Mini from "../miniCategory/Mini";
    ...
    <div className="main-wrapper-navbar">
      <Container>
        <div className="nav-items">
          <div className="hamburger-menu" onTouchEnd={() => setIsOpen(!isOpen)}>
      ...
      <div className={`pop-up-menu ${isOpen ? "open" : ""}`}>
        <div className="pop-up-section" onTouchEnd={() => setIsOpen(!isOpen)}>
          <Container>
            <Mini isOpen={isOpen} onClose={handleClose} />
          </Container>
        </div>
      </div>
    </div>
